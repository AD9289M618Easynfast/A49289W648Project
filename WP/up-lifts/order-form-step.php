...
<script src="http://max.jotfor.ms/static/jotform.forms.js?3.2.2938" type="text/javascript"></script>
<script src="http://max.jotfor.ms/js/stripe.js?v=3.2.2938" type="text/javascript"></script>
<script type="text/javascript">
    JotForm.init(function() {
        productID = {"0": "input_10_1005", "1": "input_10_1006"};
        JotForm.setCurrencyFormat('USD');
        JotForm.totalCounter({"input_10_1005": {"price": "27.95"}, "input_10_1006": {"price": "20.95", "recurring": "20.95"}});
        JotForm.setStripeSettings('pk_test_2xtCq8bzINYUSNNMNQ9ITYy7', 'none');
    });
</script>
<link href="http://max.jotfor.ms/static/formCss.css?3.2.2938" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="http://max.jotfor.ms/css/styles/pastel.css?3.2.2938" />
<link type="text/css" media="print" rel="stylesheet" href="http://max.jotfor.ms/css/printForm.css?3.2.2938" />
<style type="text/css">
    .form-label-left{
    ...
    .form-line {
        ...
        text-shadow: 0px -1px 0px rgba(2, 0, 0, 1);
    }.form-label-left {
        float: left;
    ...
    .form-all {
        padding-top: 7px;}.form-label-left {
        padding: 1px;}
    /* Injected CSS Code */
</style>

<link type="text/css" rel="stylesheet" href="http://jotformpro.com/css/styles/buttons/form-submit-button-simple_white.css?3.2.2938"/>
<form class="jotform-form" action="http://submit.jotformpro.com/submit/41202430474947/" method="post" name="form_41202430474947" id="41202430474947" accept-charset="utf-8">
    <input type="hidden" name="formID" value="41202430474947" />
    <div class="form-all">
        <ul class="form-section">
            <li class="form-line" data-type="control_image" id="id_11">
                <div id="cid_11" class="form-input-wide">
                    <img alt="" class="form-image" border="0" src="http://www.jotform.com/uploads/johnrs11/form_files/FINAL_STEPs.png" height="86" width="606" />
                </div>
            </li>
            ...
            <li class="form-line always-hidden" data-type="control_textbox" id="id_4">
            ...
            <li class="form-line" data-type="control_stripe" id="id_10">
                <label class="form-label form-label-left form-label-auto" id="label_10" for="input_10"> LIFE IS SHORT GET AN UPLIFT </label>
                <div id="cid_10" class="form-input">
                    <input type="hidden" name="simple_fpc" value="10" />
                    <span class="form-product-item hover-product-item">
                        <input class="form-radio" type="radio" id="input_10_1005" name="q10_lifeIs[][id]" value="1005" checked="checked" />
                        <label for="input_10_1005">
                    ...
                    <br />
                    <span class="form-product-item hover-product-item">
                        <input class="form-radio" type="radio" id="input_10_1006" name="q10_lifeIs[][id]" value="1006" />
                        <label for="input_10_1006">
                            25% OFF If you BUY NOW - ONE TIME OFFER + FREE SHIPPING BONUS
                            <span class="form-product-details">
                                (
                                <b>
                                    $
                                    <span id="input_10_1006_setupfee">
                                        20.95
                                    </span>
                                    USD
                                </b>
                    ...
                    <table summary="" class="form-address-table" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <span class="form-sub-label-container">
                                    <select class="form-dropdown cc_exp_month" id="input_10_cc_exp_month">
                                        <option>  </option>
                                    ...
                                    /
                                    <label class="form-sub-label" for="input_10_cc_exp_month" id="sublabel_cc_exp_month"> Expiration Month </label>
                                </span>
                                <span class="form-sub-label-container">
                                    <select class="form-dropdown cc_exp_year" id="input_10_cc_exp_year">
                                        <option>  </option>
                                    ...
                                    <label class="form-sub-label" for="input_10_cc_exp_year" id="sublabel_cc_exp_year"> Expiration Year </label>
                                </span>
                            </td>
                        </tr>
                        </tr>
            ...
            <li class="form-line" data-type="control_button" id="id_9">
                <div id="cid_9" class="form-input-wide">
                    <div style="text-align:center" class="form-buttons-wrapper">
                        <button id="input_9" type="submit" class="form-submit-button form-submit-button-img form-submit-button-simple_white">
                            <img src="http://i.ontraport.com/20100.1.2902279a12aa01c3c835005d94398db0.PNG" alt="Get UPLIFTED" />
                        </button>
                    </div>
                </div>
            </li>
    ...
    <input type="hidden" id="simple_spc" name="simple_spc" value="41202430474947" />
    <script type="text/javascript">
        document.getElementById("si" + "mple" + "_spc").value = "41202430474947-41202430474947";
    </script>
</form>