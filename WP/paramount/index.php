...
<section class="body">
    ...
    <div class="container hp-news">
        ...
        <h2 class="intro"><i class="icon-star-empty"></i> <?php _e('Upcoming events', 'clinto') ?> <i class="icon-star-empty"></i></h2>
