...
<ul class="video_list">
    ...
    <li>
        <iframe width="310" height="180" frameborder="0" src="//www.youtube.com/embed/EFr6OJsRYjQ"></iframe>
        <span>
            <b>Regi & Ameerah</b> "We Be Hot"<br/>
            <i>Creative Producer</i>
        </span>
    </li>
    <li>
    ...
    <li>
        <iframe width="310" height="180" frameborder="0" src="//www.youtube.com/embed/aET9GW-CSDc"></iframe>
        <span>
            <b>Candyman f/ Snoop</b> "High Off the Fame"<br/>
    ...
    <li>
        <iframe width="310" height="180" frameborder="0" src="//www.youtube.com/embed/txMo5h1PAU4"></iframe>
        <span>
            <b>Semi Precious Weapons</b> "Morning Walk" <br/>
    ...
    <li>
        <iframe width="310" height="180" frameborder="0" src="//www.youtube.com/embed/dXepDK4zEzY"></iframe>
        <span>
            <b>Jeffree Star</b> "Love To My Cobain"<br/>
            <i>Creative Producer</i>
        </span>
    </li>
    <li>
        <iframe width="310" height="180" frameborder="0" src="//www.youtube.com/embed/1GYS9O_Irzk"></iframe>
        <span>
            <b>Harlee</b> "Dream Warriors" <br/>
            <i>Creative Producer for Opening Sequence</i>
        </span>
    </li>
</ul>
<?php
