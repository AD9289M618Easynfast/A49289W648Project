...
<div class="<?php echo $sectionWrapper; ?>">
    <h2 class="portfolio-title"><span>NY:</span>In the Dark</h2>

    <ul class="image-gallery">
        <li>
            <a rel="prettyPhoto[ny-in-the-dark]" href="images/portfolio/ny-in-the-dark/img-1-large.jpg">
...
<!--        <li>
        ...
        <li>
            <a rel="prettyPhoto[ny-in-the-dark]" href="images/portfolio/ny-in-the-dark/img-4-large.jpg">
                <img src="images/portfolio/ny-in-the-dark/img-4.jpg" width="300"  alt="One for the Road<?php echo $imgCopyRight; ?>"/>
            </a>
        </li>
        <li>
            <a rel="prettyPhoto[ny-in-the-dark]" href="images/portfolio/ny-in-the-dark/img-5-large.jpg">
                <img src="images/portfolio/ny-in-the-dark/img-5.jpg" width="300"  alt="Time Square in the Dark<?php echo $imgCopyRight; ?>"/>
            </a>
        </li>
        <li>
            <a rel="prettyPhoto[ny-in-the-dark]" href="images/portfolio/ny-in-the-dark/img-6-large.jpg">
                <img src="images/portfolio/ny-in-the-dark/img-6.jpg" width="300"  alt="Product of New York<?php echo $imgCopyRight; ?>"/>
            </a>
        </li>
        <li>
            <a rel="prettyPhoto[ny-in-the-dark]" href="images/portfolio/ny-in-the-dark/img-7-large.jpg">
                <img src="images/portfolio/ny-in-the-dark/img-7.jpg" width="300"  alt="Tonic<?php echo $imgCopyRight; ?>"/>
            </a>
        </li>
        <li>
            <a rel="prettyPhoto[ny-in-the-dark]" href="images/portfolio/ny-in-the-dark/img-8-large.jpg">
                <img src="images/portfolio/ny-in-the-dark/img-8.jpg" width="300"  alt="NY Taxi Driver<?php echo $imgCopyRight; ?>"/>
            </a>
        </li>
        <li>
            <a rel="prettyPhoto[ny-in-the-dark]" href="images/portfolio/ny-in-the-dark/img-9-large.jpg">
                <img src="images/portfolio/ny-in-the-dark/img-9.jpg" width="300"  alt="Crossover<?php echo $imgCopyRight; ?>"/>
            </a>
        </li>
        <li>
            <a rel="prettyPhoto[ny-in-the-dark]" href="images/portfolio/ny-in-the-dark/img-10-large.jpg">
...
<!--        <li>
        ...
        <li>
            <a rel="prettyPhoto[ny-in-the-dark]" href="images/portfolio/ny-in-the-dark/img-13-large.jpg">
                <img src="images/portfolio/ny-in-the-dark/img-13.jpg" width="300"  alt="Music Walker<?php echo $imgCopyRight; ?>"/>
            </a>
        </li>
        <li>
            <a rel="prettyPhoto[ny-in-the-dark]" href="images/portfolio/ny-in-the-dark/img-14-large.jpg">
                <img src="images/portfolio/ny-in-the-dark/img-14.jpg" width="300"  alt="Brooklyn Girl<?php echo $imgCopyRight; ?>"/>
            </a>
        </li>
        <li>
            <a rel="prettyPhoto[ny-in-the-dark]" href="images/portfolio/ny-in-the-dark/img-15-large.jpg">
                <img src="images/portfolio/ny-in-the-dark/img-15.jpg" width="300"  alt="Ghost Rider<?php echo $imgCopyRight; ?>"/>
            </a>
        </li>
        <li>
            <a rel="prettyPhoto[ny-in-the-dark]" href="images/portfolio/ny-in-the-dark/img-16-large.jpg">
                <img src="images/portfolio/ny-in-the-dark/img-16.jpg" width="300"  alt="New York Minute<?php echo $imgCopyRight; ?>"/>
            </a>
        </li>
        <li>
            <a rel="prettyPhoto[ny-in-the-dark]" href="images/portfolio/ny-in-the-dark/img-17-large.jpg">
