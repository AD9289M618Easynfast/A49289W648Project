<section class="sidebar-wrapper goRight">
    <!--Tab Wrapper-->
    ...
    <section class="sidebar-list">
        ...
        <a class="bt-viewmore">view all Company Profiles</a>
    ...
    <section class="sidebar-list">
        ...
        <a class="bt-viewmore">view all Company Profiles</a>
    </section><!--Professional Placements-->
    ...
    <section class="sidebar-list">
        ...
        <a class="bt-viewmore">view all Events</a>
