...
<!--Classifields-->
<section class="classifields clearfix">
...
</section><!--Classifields-->

<!--Latest News List-->
<section class="latest-news-list clearfix">

    <!--Lastest from Mining Magazine-->
    <section class="goLeft">
        ...
        <ul>
            <li>
                <a href="#">
                    Pentagon Chielf lifts Ban on Women in Combat
                </a>
            </li>
            <li>
                <a href="#">
    ...
    </section><!--Lastest from Mining Magazine-->

    <!--Lastest from Mining News-->
    <section class="goLeft">
        <div class="line-title">
            <figure class="clearfix">
        ...
        <a class="bt-viewmore">view more</a>
    </section><!--Lastest from Mining News-->
...
<footer>
    ...
    <section class="footer-menu-wrapper clearfix">
        <!--col 1-->
        <div class="menu-col">
            <div class="footer-menu-wrapper">
                ...
                <ul class="footer-menu">
                    ...
                    <li><a href="#">AMEA</a></li>
                    <li><a href="#">Australia/Assia</a></li>
                </ul>
            </div>
        </div><!--/col 1-->
        ...
        <div class="menu-col">
            <div class="footer-menu-wrapper">
                <h2>Opinion</h2>
                <ul class="footer-menu">
                    <li><a href="#">View from the West End</a></li>
                    <li><a href="#">From the Capital</a></li>
                    <li><a href="#">Russio's rules</a></li>
                    <li><a href="#">Miner's right</a></li>
                    <li><a href="#">Marchioly</a></li>
                    <li><a href="#">Humphreys</a></li>
                    <li><a href="#">Mj comment</a></li>
                    <li><a href="#">Humphreys</a></li>
        ...
        <div class="menu-col">
            <div class="footer-menu-wrapper">
                <h2>Finance / InvestmentsF</h2>
                <ul class="footer-menu">
                    <li><a href="#">Exploration</a></li>
                    <li><a href="#">Development</a></li>
                    <li><a href="#">Production</a></li>
                    <li><a href="#">Commondities</a></li>
                    <li><a href="#">Finances</a></li>
                    <li><a href="#">Companies</a></li>
                    <li><a href="#">Politics / Trade</a></li>
        ...
        <div class="menu-col">
            <div class="footer-menu-wrapper">
                ...
                <ul class="footer-menu">
                    ...
                    <li><a href="#">Mining ICT</a></li>
                    <li><a href="#">Science R & D</a></li>
                </ul>
            </div>
        </div><!--/col 5-->
        ...
        <div class="menu-col background-color">
            ...
            <div class="footer-menu-wrapper">
                ...
                <ul class="footer-menu">
                    ...
                    <li><a href="#">Renewwals</a></li>
                    <li><a href="#">Manage Subscription</a></li>
                </ul>
            </div>
        </div><!--/col 6-->
    </section><!--/Footer Menu First Level-->
    ...
    </section><!--/Footer Menu Second Level-->

    <!--Aspermont Print Publications-->
    <section class="aspermont-clients-wrapper clearfix first-section">
        <div class="line-title">
            <h2>Aspermont Print Publications</h2>
        </div>
    ...
    </section><!--/Aspermont Print Publications-->

    <!--Aspermont Online Publications-->
    <section class="aspermont-clients-wrapper clearfix">
        <div class="line-title">
            <h2>Aspermont Online Publications</h2>
        </div>
    ...
    </section><!--/Aspermont Apps-->

    <!--Aspermont Associated Events-->
    <section class="aspermont-clients-wrapper clearfix">
        <div class="line-title">
            <h2>Aspermont Associated Events</h2>
        </div>
    ...
    <section class="content-wrapper clearfix">
        ...
        <div class="content goLeft">
            <p>
                <span>
                    Aspermont Media 2014, all rights reserved. Aspermont Media Ltd, 4th Floor, 120 Old Broad Street, London, EC2N 1AR.<br/>
                    Aspermont Media is a company registered in English and Wales. Company No. 08096447 VAT No. 136738101
                </span>
            </p>
            <p>
                Designed and Powered by Audience Media 2014
            </p>
        </div>
    </section>
</footer>
